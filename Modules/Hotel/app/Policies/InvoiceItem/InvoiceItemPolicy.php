...
namespace Modules\Hotel\Policies\InvoiceItem;
...
class InvoiceItemPolicy
{
    ...
    {
        return $user->hasPermissionTo('view-any-invoiceItem');
    }
    ...
    {
        return $user->hasPermissionTo('update-invoiceItem');
    }
    ...
    {
        return $user->hasPermissionTo('restore-invoiceItem');
    }
    ...
    {
        return $user->hasPermissionTo('force-delete-invoiceItem');
    }
}
